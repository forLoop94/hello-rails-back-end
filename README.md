...
**Hello rails app:** This project employs a Ruby on Rails api app with PostgreSQL database as a back end app to a  react and redux  front end app to practice creating two applications using for both front end and back end.This is giving a endpoint which contain random greeting to the user. 📚
...
2. Clone this repo
```
git clone https://github.com/forLoop94/hello_rails_back_end.git
```
...
Feel free to check the [issues page](https://github.com/forLoop94/hello-rails-back-end/issues)
